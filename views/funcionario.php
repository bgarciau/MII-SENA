    ...
    <div style="min-height: 85vh;">
        <div class="container font-weight-bold mt-3">
            <div class="row">
                <div class="col-md-6">
                    <!-- Crear el formulario -->
                    <h2 class="text-center mb-4">DATOS DE FUNCIONARIO</h2>
                    <?php
                    ...
                    <div class="col-md-6 justify-content-center">
                        ...
                        <div class="carnet-body">
                            <div class="carnet-container">
                                ...
                                <!-- <img src="carnet/Sena.jpg" alt="" width="100px" height="100px" style='float:left; top:-100px; position:relative;'> -->
                                <!-- <div class="title">
                                    <h6><strong>Paula de Santiago <br>
                                        Valencia Alvares</strong></h6>
                                </div> -->
